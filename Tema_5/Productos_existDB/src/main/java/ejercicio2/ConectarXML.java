...
public class ConectarXML {
    ...
    private static String COLLECTION = "Ejercicios/Videojuegos";
...
Database database = (Database) cl.getDeclaredConstructor().newInstance();        database.setProperty("create-database", "true");

...
public class QueryXML_Anio {
    ...
    private static String COLLECTION = "Ejercicios/Marvel";
    
    // Nombre del recurso XML dentro de la colección
    private static String RESOURCE = "peliculas_marvel.xml";
    ...
    public static void main(String args[]) throws Exception {
        ...
        try {
            ...
            if(res == null) {
                ...
                String xquery = "/peliculas_marvel/pelicula[año >= 2016]"; 
